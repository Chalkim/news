...
public class MongoTest {
    ...
    public void saveTest(){
        for (int i = 0; i < 10; i++) {
            ...
            apAssociateWords.setAssociateWords("黑马头条" + i);
    ...
    public void testQuery(){
        Query query = Query.query(Criteria.where("associateWords").regex(".*黑马头条.*"))
    ...
    @Test
    public void testDel(){
        mongoTemplate.remove(Query.query(Criteria.where("associateWords").regex("黑马头条.*")),ApAssociateWords.class);
    }
}
